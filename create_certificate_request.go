...
func CreateCertificateRequest(subject Subject, publicKeyBytes []byte, certificateType CertificateType, validFor time.Duration, criticalOptions, extensions map[string]string) ([]byte, error) {
